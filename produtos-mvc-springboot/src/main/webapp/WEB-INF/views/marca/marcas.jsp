		    	...
		    	<div> 
        			<div class="row">
            			<div class="col-md-12">
							...
							<a class="btn btn-secondary" href="${contextPath}/categoria/form?page=categoria-novo">Nova Marca</a>
				    ...
				    <tr>
				      ...
				      <td>
				      	  <form:form action="${contextPath}/categoria/${categoria.idCategoria}" method="delete">
					          <a href="${contextPath}/categoria/${categoria.idCategoria}"  class="btn btn-success btn-sm">Categoria</a>
